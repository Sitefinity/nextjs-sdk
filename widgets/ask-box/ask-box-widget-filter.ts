...
/**
 * Widget filter function for AskBox widget.
 ...
 */
export async function filterAskBoxWidget(widgetMetadata: WidgetMetadata, args: GetWidgetsArgs): Promise<boolean> {
    // Only apply filtering logic to SitefinityAskBox widget
    if (widgetMetadata.designerMetadata?.Name !== 'SitefinityAskBox') {
        return true;
    }
