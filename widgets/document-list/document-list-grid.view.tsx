...
export function DocumentListGridView(props: DocumentListMasterViewProps<DocumentListEntity>) {
          ...
          <thead>
            <tr className="row g-0">
              <th className="col-5 border-secondary">
                <span className="fw-bold">{props.titleColumnLabel}</span>
              </th>
              <th className="col-2 border-secondary">
                <span className="fw-bold">{props.typeColumnLabel}</span>
              </th>
              <th className="col-2 border-secondary text-end">
                <span className="fw-bold">{props.sizeColumnLabel}</span>
              </th>
